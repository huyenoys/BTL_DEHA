...
<hr style="border:1px solid; background-color:#8a7b6d; border-color:#3B3131;">
    ...
    <a href="#subject"   onclick="showSubject()" ><i class="fa fa-th-large"></i> Subject</a>
    <a href="#teachers"   onclick="showTeachers()" ><i class="fa fa-th"></i> Teachers</a>
    <!-- <a href="#productsizes"   onclick="showProductSizes()" ><i class="fa fa-th-list"></i> Product Sizes</a>     -->
    <a href="#courses"   onclick="showCourseItems()" ><i class="fa fa-th"></i> Courses</a>
